...
import { Box, Button, TextField, Typography, Autocomplete, Modal, Paper } from '@mui/material';
      ...
      <Box className='impresion-card-bfx' sx={{ pt: 8 }}>
        ...
        <Box className='impresion-form-bfx'>
          ...
          <TextField
            ...
            variant="outlined"
            type="number"
            value={pesoBruto === undefined ? '' : pesoBruto}
          ...
          <TextField
            ...
            variant="outlined"
            type="number"
            value={pesoNeto === undefined ? '' : pesoNeto}
